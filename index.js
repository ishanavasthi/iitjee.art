...
const serviceaccounts = [
    ...
    const authConfig = {
        "siteName": "site-name", // Website name
        "client_id": "id", // Client id from Google Cloud Console
        "client_secret": "secret", // Client Secret from Google Cloud Console
        "refresh_token": "token", // Authorize token
   ...
   editable values below*/
    ...
    const uiConfig = {
        ...
        "favicon": "https://img.icons8.com/external-flaticons-flat-flat-icons/344/external-lecturer-university-flaticons-flat-flat-icons-3.png",
        // if logo is true then link otherwise just text for name
        "logo_link_name": "https://img.icons8.com/external-flaticons-flat-flat-icons/344/external-lecturer-university-flaticons-flat-flat-icons-3.png",
        ...
        "contact_link": "https://ishanavasthi.in?utm_source=iitjee.art", // Link to Contact Button on Menu
        ...
        "unauthorized_owner_link": "https://ishanavasthi.in", // Unauthorized Error Page Link to Owner
        "unauthorized_owner_email": "hello@ishanavasthi.in", // Unauthorized Error Page Owner Email
                      ...
                      <div class="container">
                         <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto">
                               ...
                               <p class="text-muted mb-4">Welcome to Sign-in page</p>
